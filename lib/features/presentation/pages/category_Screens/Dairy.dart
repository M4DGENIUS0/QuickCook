...
class _DairyScreenState extends State<DairyScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        floatingActionButton: prov.selectindex.length > 0
        ...
        body: prov.isGridView
            ? const GridviewDisplay(
                category: '/api/dairy', Location: 'Dairy',
              )
            : ListviewDisplay(category: '/api/dairy'));
  }
}
