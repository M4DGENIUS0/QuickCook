...
class ShakesScreen extends StatefulWidget {
  const ShakesScreen({super.key});

  @override
  State<ShakesScreen> createState() => _ShakesScreenState();
}
...
class _ShakesScreenState extends State<ShakesScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: prov.isGridView ? const GridviewDisplay(category: '/api/shakes', Location: 'Shakes',) : const ListviewDisplay(category: '/api/shakes',) 
    );
  }
}
