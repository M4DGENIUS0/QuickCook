...
class _FlourScreenState extends State<FlourScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: prov.isGridView ? const GridviewDisplay(category: '/api/flour', Location: 'Flour',) : const ListviewDisplay(category: '/api/flour',) 
    );
  }
}
